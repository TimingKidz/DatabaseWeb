    ...
    public function cartCheckout(Request $request) {
        ...
        try{
            ...
            if($request->vcode == ""){
                ...
                values (strftime('%Y-%m-%d', date('now')),'$request->reqDate','','In Process','','$request->cusnum','$total','$point','$request->shipaddrnum','$request->billaddrnum');");
            }else{
                ...
                values (strftime('%Y-%m-%d', date('now')),'$request->reqDate','','In Process','','$request->cusnum','$request->vcode','$total','$point','$request->shipaddrnum','$request->billaddrnum');");
            }
